...
const ToolTip: FC<ToolTipProps> = ({
	...
	return (
		<div className={`${closeToolTip ? 'hidden' : ''} absolute left-0 w-full max-w-[220px] z-10 m-1`}>
			...
			}} type='button' className='absolute top-4 right-0 rounded-md p-2 inline-flex items-center justify-center text-black hover:text-gray-500  focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500'>
