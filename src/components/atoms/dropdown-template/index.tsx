...
const DropdownTemplate: FC<DropdownTemplateProps> = ({
	...
	<>
        ...
        md:border border-solid border-gray-200 py-5 sm:top-11 md:top-6.25 transform origin-top transition ${display ? 'opacity-100 rotateX-0 visible' : 'invisible opacity-30 rotateX-90'}`}>
			{children}
		</div>
	</>
);
